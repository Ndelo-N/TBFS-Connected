const CACHE_NAME = 'tbfs-loan-manager-v69'; // manageLoanClientPortal keeps account-priority resolve
const urlsToCache = [
  './',
  ...
  './shared/app-state.js?v=69',      // manageLoanClientPortal keeps account-priority resolve
  './shared/navigation.js?v=69',     // manageLoanClientPortal keeps account-priority resolve
  './shared/calculations.js?v=69',   // manageLoanClientPortal keeps account-priority resolve
  './shared/styles.css',             // manageLoanClientPortal keeps account-priority resolve
  './shared/sw-register.js?v=69',    // manageLoanClientPortal keeps account-priority resolve
  './shared/sanitize.js?v=69',       // manageLoanClientPortal keeps account-priority resolve
  './shared/cloud-backup.js?v=69',   // manageLoanClientPortal keeps account-priority resolve
  './shared/client-status.js?v=69',  // manageLoanClientPortal keeps account-priority resolve
  './shared/loan-statement-pdf.js?v=69', // manageLoanClientPortal keeps account-priority resolve
